...
// File: contracts/KuberCryptoCard.sol
...
contract KuberCryptoCard is ERC721, Ownable {
    using Strings for uint256;

    uint public constant MAX_TOKENS = 10000;
    uint private constant TOKENS_RESERVED = 100;
    uint public price = 100000000000000000000;
    ...
    constructor() ERC721("Kuber Crypto Card", "KCC") {
        baseUri = "https://nft.kuberdefi.com/metadata/kuber/crypto-card/";
