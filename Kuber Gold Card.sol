...
// File: contracts/KuberGoldCard.sol
...
contract KuberGoldCard is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("Kuber Gold Card", "KGC") {
        baseUri = "https://nft.kuberdefi.com/metadata/kuber/gold-card/";
